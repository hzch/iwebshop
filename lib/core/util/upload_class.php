                	...
                	else
                	{
		                ...
		                else
		                {
		                    ...
		                    else
		                    {
			                    ...
			                    if(is_file($_FILES[$field]['tmp_name'][$key]))
			                    {
			                        if(IFile::xcopy($_FILES[$field]['tmp_name'][$key],$this->dir.$fileInfo[$key]['name']))
			                        {
			                            if(is_file($_FILES[$field]['tmp_name'][$key]))
			                            {
            	...
            	else
            	{
                	...
                	else
                	{
		                ...
		                else
		                {
			                ...
			                {
			                    if(IFile::xcopy($_FILES[$field]['tmp_name'],$this->dir.$fileInfo[0]['name']))
			                    {
			                        if(is_file($_FILES[$field]['tmp_name']))
			                        {
