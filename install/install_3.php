...
<div class="container">
				...
				<div class="log_box">
					...
					<div class="gray_box">
						<div class="box">
							...
							<strong>安装选择</strong>
							<label for=""><input class="radio" type="radio" name='install_type' value='all' <?php if(!file_exists(ROOT_PATH.'./install/iwebshop_test.sql')){?> disabled=disabled <?php }?> />安装完整：安装所有模块，并安装体验数据</label><br />
	...
	<div class="foot"><a href="http://www.jooyea.cn">关于我们</a>|<a href="http://www.jooyea.cn">官方网站</a>|<a href="http://www.jooyea.cn">联系我们</a>|<a href="">©2005-2011</a></div>
</div>
